...
var CardDecks = [{
        ...
        cards: [{
            ...
            },
            {
                ...
                firstChoice: {
                    text: "לתת לפיאודום להישאר (אבל הוא אף פעם לא יהיה חזק מהממלכה שלך)",
                    onclick: nextCard
                },
                secondChoice: {
                    text: "להסתער על הפיאודום (דורש 4 כוח אדם, מחזיר 5 שטח)",
                    onclick: function () {
            ...
            },
            {
                ...
                secondChoice: {
                    text: "להסתער על הפיאודום (דורש 7 כוח אדם, מחזיר 8 שטח).",
                    onclick: function () {
            ...
            {
                title: "ב" + dictLink("dict-feodom", "פיאודום") + " קרוב האדון וכל משפחתו נרצחו. לאחר שנוצר הכאוס, אבירים רבים מחפשים איש חדש לשרת.",
    ...
    },
    {
        ...
        cards: [{
            ...
            {
                title: "מלחמה בין ממלכה לפיאודום",
                description: "פיאודום בגודל קטן ממלכתך, מהמזרח, מכריזה עליך מלחמה.",
                firstChoice: {
                ...
                secondChoice: {
                    text: "להגן (מבזבז 5 כוח אדם (לא מביא שטח רק מבריח את האבירים של הפיאודום השני)",
                    onclick: function () {
                        Game.bars.soldier.value -= 5;
                        nextCard();
                    }
